...
def part1_sum_fn(sort_updates, updates):
    return sort_updates == updates

def part2_sum_fn(sort_updates, updates):
    return sort_updates != updates
    
def part(file_name, should_consider_sum_fn):
    middle_page_sum = 0
    update_mode = False
        ...
        for line in f:
            ...
            if line:
                if not update_mode:
                    ...
                    # print("-->", sort_updates)
                    if should_consider_sum_fn(sort_updates, updates):
                        # print("===sumFnTrue:", sort_updates[len(sort_updates) // 2])
                        middle_page_sum += sort_updates[len(sort_updates) // 2]
                        continue
                    # print("===NOPE")
...
assert part("day5_example.txt", part1_sum_fn) == 143
assert part("day5_example.txt", part2_sum_fn) == 123



def part1():
    return part("day5.txt", part1_sum_fn)

def part2():
    return part("day5.txt", part2_sum_fn)
