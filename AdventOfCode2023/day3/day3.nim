...
proc day3(fileName: string): int =
    var partSum = 0
    var numbers: seq[tuple[n: int, r: int, st: int, en: int]]
...
#     check day3("day3_sample.txt") == 4361
# test "day3_sample2.txt":
#     check day3("day3_sample2.txt") == 4
# test "day3_sample3.txt":
#     check day3("day3_sample3.txt") == 9 
test "day3.txt":
    check day3("day3.txt") == 4361
